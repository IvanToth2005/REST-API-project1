 ...
 */
    ...
    {
        $film = Films::with('actors')->findOrFail($id);
    ...
    public function updateFilmActor(Request $request, $filmId, $actorId)
{
    ...
    $actor = Actors::findOrFail($actorId);
...
public function removeFilmActor(Films $film, Actors $actor)
{
...
{
    $film = Films::with('director')->findOrFail($id);
...
public function updateFilmDirector($filmId, $directorId)
{
    ...
    $director = \App\Models\Directors::find($directorId);
