...
class DirectorsControllerTest extends TestCase
{
    ...
    {
        Directors::factory()->create(['name' => 'James Cameron']);
        Directors::factory()->create(['name' => 'Christopher Nolan']);
    ...
    {
        $director = Directors::factory()->create(['name' => 'Old Name']);
    ...
    {
        $director = Directors::factory()->create(['name' => 'To Delete']);
